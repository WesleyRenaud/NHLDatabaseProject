/**
 * A class that bridges the UI of the database and actual database, managing how the user adds
 * and edits player data.
 */
...
public class NHLPlayerEditor
{
     ...
     * @param team          The skater's team.
     */
    private void addRetiredSkaterStats( String firstSeason, String lastSeason, String name, String birthday, String handedness, 
                                                                                                int number, String team )
    {
        String currentSeason = firstSeason;
        while (SeasonHandler.getFirstYear_AsInt( currentSeason ) < 2024)
        {
     ...
     * @param team          The goalie's team.
     */
    private void addRetiredGoalieStats( String firstSeason, String lastSeason, String name, String birthday, String handedness, 
                                                                                                int number, String team )
    {
        String currentSeason = firstSeason;
        while (SeasonHandler.getFirstYear_AsInt(currentSeason) < 2024)
    ...
    protected void editPlayerCurrentSeasonStats()
    {
        ...
        if (players.checkPlayerExists( playerName )) {
            ...
            if (players.checkPlayerIsSkater( playerName )) {
                ...
                editGoalieSeasonStats( playerName, season );
            }
            InputReader.readBuffer();
        } else {
            System.out.println( " ! The Player Does not Exist !" );
    ...
    /**
     * Updates the stats for a player supplied as input in a season supplied as input.
     */
    ...
    /**
     * Edits the current season stats for a skater supplied as a parameter.
     * 
     * @param playerName    The name of the player whose stats are being edited.
     * @param season        The season in which the stats are being edited.
     */
    protected void editSkaterSeasonStats( String playerName, String season )
    {
        ...
        int assists = InputReader.getIntegerInput( " * Assists >> " );
        int plusMinus = InputReader.getIntegerInput( " * Plus-Minus >> " );
        players.editSkaterSeasonStats( playerName, season, gamesPlayed, goals, assists, plusMinus );
    }

    /**
     * Edits the current season stats for a goalie supplied as a parameter.
     */
    protected void editGoalieSeasonStats( String playerName, String season )
    {
        int wins = InputReader.getIntegerInput( " * Wins >> " );
        int loses = InputReader.getIntegerInput( " * Loses >> " );
        int overtimeLoses = InputReader.getIntegerInput( " * Overtime Loses >> " );
        double savePercentage = InputReader.getDoubleInput( " * Save Percentage >> " );
        double goalsAgainstAverage = InputReader.getDoubleInput( " * Goals Against Average >> " );
        players.editGoalieSeasonStats( playerName, season, wins, loses, overtimeLoses, savePercentage, goalsAgainstAverage );
    }
    ...
    protected void editPlayerTeam()
    {
        ...
        if (players.checkPlayerExists( playerName )) {
            ...
            players.editTeam( playerName, team );
        } else {
            System.out.println( " ! The Player Does not Exist !" );
        }
    }
    ...
    /**
     * Edits the jersey number of a player.
     */
    protected void editPlayerNumber()
    {
        ...
        if (players.checkPlayerExists( playerName )) {
            ...
            players.editNumber( playerName, number );
        } else {
            System.out.println( " ! The Player Does not Exist !" );
        }
    }
    ...
    protected void editPlayerName()
    {
        ...
        if (players.checkPlayerExists( currentName )) {
            ...
            players.editName( currentName, newName );
        } else {
            System.out.println( " ! The Player Does not Exist !" );
        }
    }
    ...
    /**
     * Edits the birthday of a player.
     */
    protected void editPlayerBirthday()
    {
        ...
        if (players.checkPlayerExists( playerName )) {
            ...
            players.editBirthday( playerName, birthday );
        } else {
            System.out.println( " ! The Player Does not Exist !" );
        }
    }
